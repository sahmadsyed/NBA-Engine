...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app1_player', 'stats',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app1.Stats']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.stats'
        db.delete_column('app1_player', 'stats_id')
    ...
    models = {
        'app1.player': {
            ...
            'stats': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['app1.Stats']"}),
